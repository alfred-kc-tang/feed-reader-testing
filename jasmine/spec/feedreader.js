    ...
    */
    ...
    describe('Initial Entries', function() {
        ...
        it('there is at least an .entry element in the .feed container', function () {
             ...
             */
            /* 'expect($('.feed .entry')).toExist();' and 
             * 'expect($('.feed .entry')).toBeInDom();'' no longer work
             */
        }); 
    });  
    ...
    describe('New Feed Selection', function() {
        ...
        it('the content does change when a new feed is loaded', function () {
            expect(newEntries).not.toBe(oldEntries);
            // the content of the entries are supposed to be different
        });
    });
}());
